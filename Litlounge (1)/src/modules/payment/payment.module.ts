...
import { SubscriptionController } from './controllers/subscription-plan.controller';
...
@Module({
  ...
  exports: [...paymentProviders, PaymentService, PaymentSearchService, OrderService, SubscriptionPlanService]
})
