...
export class UserService {
  ...
  public async findByVerificationId(verificationId: string): Promise<UserModel> {
    return this.userModel.findOne({ verificationId });
  }
  ...
  public async create(
    ...
    const balance =
      (await this.settingService.getKeyValue(SETTING_KEYS.FREE_TOKENS)) || 0;
